...
import kimmy from '../../Pictures/StoicKim.png'


export default class Kimmy extends Component {
    constructor(props) {
        super(props)
        this.state = {
            name: 'Kimmy',
    ...
    render() {
        return (
            ...
            <div className='player-chips'><img className='chips-pic' src={chipPic} alt="" /></div>
                ...
                <div className='player-face'><img className='playerFace' src={kimmy} alt="" /></div>
